...
impl LegionellaCustomIntrinsicMirGen for ComputePipelineLayoutDesc {
    ...
    where 'tcx: 'a,
  {
    ...
    for desc_set in desc_set_bindings.iter() {
      ...
      let (alloc_id, ..) = static_tuple_alloc(tcx,
                                              "desc set bindings",
...
fn build_compiler_descriptor_desc<'a, 'tcx>(tcx: TyCtxt<'a, 'tcx, 'tcx>,
                                            ty: DescriptorDesc)
  -> ConstValue<'tcx>
{
...
fn build_compiler_shader_stages<'a, 'tcx>(tcx: TyCtxt<'a, 'tcx, 'tcx>,
                                          ty: ShaderStages)
  -> Vec<ConstValue<'tcx>>
{
  let tuple = [
...
fn build_compiler_descriptor_desc_ty<'a, 'tcx>(tcx: TyCtxt<'a, 'tcx, 'tcx>,
                                               ty: DescriptorDescTy)
  -> Vec<ConstValue<'tcx>>
{
  println!("desc ty: {:?}", ty);
...
fn build_compiler_descriptor_img_desc<'a, 'tcx>(tcx: TyCtxt<'a, 'tcx, 'tcx>,
...
fn build_compiler_descriptor_img_array<'a, 'tcx>(tcx: TyCtxt<'a, 'tcx, 'tcx>,
...
fn build_compiler_descriptor_texel_buffer<'a, 'tcx>(tcx: TyCtxt<'a, 'tcx, 'tcx>,
...
fn build_compiler_descriptor_input_attachment<'a, 'tcx>(tcx: TyCtxt<'a, 'tcx, 'tcx>,
...
fn build_compiler_descriptor_buffer<'a, 'tcx>(tcx: TyCtxt<'a, 'tcx, 'tcx>,
...
fn desc_img_dims_ty<'a, 'tcx>(tcx: TyCtxt<'a, 'tcx, 'tcx>) -> ty::Ty<'tcx> {
  tcx.types.u32
}
fn desc_img_array_ty<'a, 'tcx>(tcx: TyCtxt<'a, 'tcx, 'tcx>) -> ty::Ty<'tcx> {
  let tup = [tcx.types.bool, mk_static_slice(tcx, tcx.types.u32), ];
  tcx.mk_tup(tup.iter())
}
fn vk_format_ty<'a, 'tcx>(tcx: TyCtxt<'a, 'tcx, 'tcx>) -> ty::Ty<'tcx> {
  tcx.types.u32
}
fn desc_img_desc_ty<'a, 'tcx>(tcx: TyCtxt<'a, 'tcx, 'tcx>) -> ty::Ty<'tcx> {
  let tup = [
    tcx.types.bool,
...
fn desc_buffer_desc_ty<'a, 'tcx>(tcx: TyCtxt<'a, 'tcx, 'tcx>) -> ty::Ty<'tcx> {
  let tup = [
...
fn desc_desc_ty_kind_ty<'a, 'tcx>(tcx: TyCtxt<'a, 'tcx, 'tcx>) -> ty::Ty<'tcx> {
  tcx.types.u32
}
fn desc_desc_ty_ty<'a, 'tcx>(tcx: TyCtxt<'a, 'tcx, 'tcx>) -> ty::Ty<'tcx> {
  let tup = [
...
fn shader_stages_ty<'a, 'tcx>(tcx: TyCtxt<'a, 'tcx, 'tcx>) -> ty::Ty<'tcx> {
  let tup = [tcx.types.bool; 6];
  tcx.mk_tup(tup.iter())
}
fn desc_desc_ty<'a, 'tcx>(tcx: TyCtxt<'a, 'tcx, 'tcx>) -> ty::Ty<'tcx> {
  let tup = [
    desc_desc_ty_ty(tcx),
    tcx.types.u32,
...
fn desc_bindings_desc_ty<'a, 'tcx>(tcx: TyCtxt<'a, 'tcx, 'tcx>) -> ty::Ty<'tcx> {
  mk_static_slice(tcx, mk_static_slice(tcx, desc_desc_ty(tcx)))
}
fn desc_set_bindings_desc_ty<'a, 'tcx>(tcx: TyCtxt<'a, 'tcx, 'tcx>) -> ty::Ty<'tcx> {
